package
{
	...
	private var maxSpeed:Number = 10.0;
	...
	public var targetArrow:Arrow = null;
	...
	public function update(mouseX:Number, mouseY:Number):void{
	    switch(this.type){
	    case SEEK:
		updateSeek(mouseX, mouseY);
		break;
	    case FLEE:
		updateFlee(mouseX, mouseY);
		break;
	    case ARRIVE:
		updateArrive(mouseX, mouseY);
		break;
	    }
	}
	public function updateSeek(mouseX:Number, mouseY:Number):void{
	...
	public function updateFlee(mouseX:Number, mouseY:Number):void{
	    var dx:Number = mouseX - this.x;
	    var dy:Number = mouseY - this.y;
	...
	public function updateArrive(mouseX:Number, mouseY:Number):void{
	    var dx:Number = this.targetArrow.x - this.x;
	    var dy:Number = this.targetArrow.y - this.y;
